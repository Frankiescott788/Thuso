...
const Dashboard_layout = () => {
  return (
    <>
      <aside className="fixed top-0  bottom-0 left-0 grid grid-cols-12">
        <div className="col-span-6 border-r px-1 ">
          ...
          <ul className="aside-nav mt-14">
            <li className="flex gap-1 pr-[5rem] pl-3 py-2 rounded bg-[#0496ff] text-white">
              <div>
                <svg
            ...
            <li className="flex gap-1 pr-[5rem] pl-3 py-2">
              <div>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
      ...
      <nav className="fixed top-0 right-0 left-0 border-b ms-[12.6rem] py-4 px-3">
      ...
      <main className="ms-[14.4rem] mt-[15dvh]">{<Outlet />}</main>
    </>
  );
};
